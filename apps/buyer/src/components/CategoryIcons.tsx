...
export const BagIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    <path d="M16 22 C16 18, 18 16, 22 16 H42 C46 16, 48 18, 48 22 L45 50 C44.5 53, 43 54, 40 54 H24 C21 54, 19.5 53, 19 50 Z" stroke={outlineColor} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="#FFFFFF" />
...
export const MobilesIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    <rect x="18" y="10" width="28" height="44" rx="6" stroke={outlineColor} strokeWidth="3" fill="#FFFFFF" />
...
export const ElectronicsIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    <rect x="15" y="14" width="34" height="25" rx="3" stroke={outlineColor} strokeWidth="3" fill="#FFFFFF" />
...
export const BeautyIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    ...
    <rect x="23" y="28" width="18" height="26" rx="3" stroke={outlineColor} strokeWidth="3" fill="#FFFFFF" />
...
export const AppliancesIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    <rect x="10" y="14" width="44" height="28" rx="3" stroke={outlineColor} strokeWidth="3" fill="#FFFFFF" />
...
export const ToysIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    <circle cx="21" cy="17" r="5" stroke={outlineColor} strokeWidth="2.5" fill="#FFFFFF" />
    <circle cx="43" cy="17" r="5" stroke={outlineColor} strokeWidth="2.5" fill="#FFFFFF" />
    <path d="M21 28 C17 34, 16 46, 23 51 C27 53, 37 53, 41 51 C48 46, 47 34, 43 28 Z" stroke={outlineColor} strokeWidth="3" fill="#FFFFFF" />
    <ellipse cx="32" cy="23" rx="11" ry="9" stroke={outlineColor} strokeWidth="3" fill="#FFFFFF" />
    ...
    <ellipse cx="32" cy="24" rx="2.5" ry="1.8" stroke={outlineColor} strokeWidth="1.5" fill="#FFFFFF" />
  </svg>
);
...
export const NutritionIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    <rect x="22" y="10" width="20" height="7" rx="2" stroke={outlineColor} strokeWidth="3" fill="#FFFFFF" />
    <rect x="18" y="17" width="28" height="35" rx="5" stroke={outlineColor} strokeWidth="3" fill="#FFFFFF" />
...
export const AutoIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    <path d="M14 36 C14 20, 24 12, 42 12 C52 12, 54 22, 54 32 C54 44, 44 52, 30 52 C20 52, 14 46, 14 36 Z" stroke={outlineColor} strokeWidth="3" strokeLinejoin="round" fill="#FFFFFF" />
...
export const SportsIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    ...
    <path d="M44 18 L18 44 C16 46, 16 49, 18 51 L20 53 C22 55, 25 55, 27 53 L53 27 C54.5 25.5, 54.5 23, 53 21.5 L47 15.5" stroke={outlineColor} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="#FFFFFF" />
...
export const FurnitureIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    <path d="M20 18 C20 14, 44 14, 44 18 V34 H20 Z" stroke={outlineColor} strokeWidth="3" strokeLinejoin="round" fill="#FFFFFF" />
    <rect x="18" y="34" width="28" height="9" rx="2" fill={accentColor} stroke={outlineColor} strokeWidth="2.5" />
    <path d="M11 28 C11 26, 13 25, 15 25 H18 V43 H14 C12.3 43, 11 41.7, 11 40 Z" stroke={outlineColor} strokeWidth="3" strokeLinejoin="round" fill="#FFFFFF" />
    <path d="M53 28 C53 26, 51 25, 49 25 H46 V43 H50 C51.7 43, 53 41.7, 53 40 Z" stroke={outlineColor} strokeWidth="3" strokeLinejoin="round" fill="#FFFFFF" />
...
export const BooksIcon: React.FC<CategoryIconProps> = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size} fill="none" className={className} {...props}>
    <rect x="18" y="10" width="28" height="44" rx="4" stroke={outlineColor} strokeWidth="3" fill="#FFFFFF" />
...
export function getCategoryIcon(name: string, active = false, isDarkMode = false) {
  const lower = name.toLowerCase();
  const accent = '#10B981';
  const outline = isDarkMode ? '#E5E7EB' : '#2B2D42';
  const size = 40;
